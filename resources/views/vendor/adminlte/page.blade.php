    ...
    <div id="wrapper">
        ...
        <div class="left side-menu">
          <div class="user-details">
              ...
              <div class="user-info">
                  <a href="#">{{ $user->name }}</a>
                  <p class="text-muted m-0">{{ $user->hasRole('admin') ? 'Administrador' : 'Usuário' }}</p>
              </div>
          </div>
          ...
          <div id="sidebar-menu">
              ...
              <ul class="metismenu" id="side-menu">
                  ...
                  <li>
                      <a href="javascript: void(0);"><i class="ti-home"></i><span> Cadastros </span> <span class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="{{ route('clients.index') }}">Clientes</a></li>
                          <li><a href="{{ route('vendors.index') }}">Fornecedores</a></li>
                          <li><a href="{{ route('employees.index') }}">Funcionários</a></li>
                      </ul>
                  </li>

                  <li>
                      <a href="javascript: void(0);"><i class="ti-home"></i><span> Produtos </span> <span class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="{{ route('products.index') }}">Gerenciar</a></li>
                          <li><a href="{{ route('values.index') }}">Valores Venda</a></li>
                          <li>
                            <a href="javascript: void(0);"><span> Auxiliáres </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ route('groups.index') }}">Grupos</a></li>
                                <li><a href="{{ route('extras.index') }}">Campos Extras</a></li>
                            </ul>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li>
                      <a href="javascript: void(0);"><i class="mdi mdi-google-maps"></i><span> Configurações </span> <span class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="{{ route('config_empresa') }}">Empresa</a></li>
                      </ul>
                  </li>
